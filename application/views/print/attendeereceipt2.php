...
<div style="width:100%;position:relative;display:block;font-family:Helvetica,Arial,Sans-serif;font-size:9px;margin:0;">
	<div style="width:100%;position:relative;display:block;margin:0;float:left;">
		<div style="position:relative;display:inline-block;float:left;margin:0 10px 10px 0;"><img src="http://www.ipaconvex.com/images/ipa-logo.jpg" style="width:70px;"></div>
	...
	<div style="width:100%;position:relative;display:block;float:left;font-size:9px;">
		...
		<div style="width:30%;position:relative;display:inline-block;float:left;">
			<?php if($data['regtype'] == 'PD' || $data['regtype'] == 'PO'):?>
				<h4 style="margin:0;padding:0;">DELEGATE</h4>
			<?php else:?>
				<h4 style="margin:0;padding:0;">STUDENT</h4>
			<?php endif;?>
		...
		<div style="width:30%;position:relative;display:inline-block;float:left;text-align:right;">
			<h4 style="margin:0;padding:0;"><?php echo $data['registrationnumber'];?></h4>
		</div>
	</div>
