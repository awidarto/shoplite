...
Route::controller(array('register','shop','shoppers','shopper','carts','promotions','products','report','import','export','dashboard','user','users','message','search','activity','category','content','ajax'));
